...
public class Cliente {
	...
	static String datoRecogido = "";
	static String dataParaElServidor = "";
		...
		try (Scanner sc = new Scanner(System.in);){
			...
			do {
				...
				case "4":
					...
					break;
				case "5":
					System.out.println("Para añadir un libro tiene que rellenar los siguientes campos");
					break;
				default:
					System.out.println("Número invalido");
					main(null);
				}
				if (numeroSeleccionado.equalsIgnoreCase("5")) {
					
				} else {
					 datoRecogido = sc.nextLine();
					 dataParaElServidor = numeroSeleccionado + "/" + datoRecogido;//3-41
				}  
